...
- Plugins are separate crates (`plugins/askar/Cargo.toml`) — they are never compiled into the core ASDK library; consumers must explicitly depend on them.
