...
from the EQUS Credentials SDK Rust library, packaged as an Android AAR archive.
...
## Dependencies
- Depends on: the UniFFI Kotlin wrapper (`wrappers/uniffi/` built as `android-release.aar`), `demos/oid4vc/` issuer and verifier services running on host
- Used by: developers evaluating the SDK on Android
