...
the EQUS SDK Rust library, packaged as an XCFramework and Swift bindings.
...
## Dependencies
- Depends on: EQUS SDK UniFFI Swift wrapper (XCFramework built from `wrappers/uniffi/`), `demos/oid4vc/` issuer and verifier services
- Used by: developers evaluating EQUS SDK on iOS
