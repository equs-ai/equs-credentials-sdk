...
@MainActor
final class OID4VCViewModel: ObservableObject, AuthCodeCallback {
	...
	private static func buildOid4vciHolder(kms: InMemKms, vault: InMemVault) async throws
		-> Oid4vciHolder
	{
	...
	private static func buildOid4vpHolder(kms: InMemKms, vault: InMemVault) async throws
		-> Oid4vpHolder
	{
