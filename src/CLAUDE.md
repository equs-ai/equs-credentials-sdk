...
## Purpose
Root of the ASDK Rust library. Defines the core trait interfaces (crypto, HTTP, KMS, storage, vault, nonce) that the rest of the SDK builds on, and re-exports all functional modules.
