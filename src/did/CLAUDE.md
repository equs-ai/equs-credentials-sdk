...
## Purpose
Owns all DID method implementations and the universal resolver used throughout EQUS Credentials SDK for DID resolution, DID document generation, and verification method lookup.
