...
## Purpose
Provides complete in-memory implementations of every EQUS Credentials SDK persistence and key-management interface, enabling tests and quick-start applications without external dependencies.
