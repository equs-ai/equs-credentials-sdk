...
pub use crate::vc::oid4vp::delegate::*;
...
pub use openid4vp::core::authorization_request::parameters::DelegateSdJwtTransactionData;
pub use openid4vp::core::authorization_request::parameters::TransactionDataItemTypeContent;
...
pub fn as_delegate(item: &TransactionDataItem) -> Option<&DelegateSdJwtTransactionData> {
    match &item.content {
        TransactionDataItemTypeContent::DelegateSdJwt(d) => Some(d),
        _ => None,
    }
}
