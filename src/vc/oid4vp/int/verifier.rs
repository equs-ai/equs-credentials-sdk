...
use crate::vc;
use crate::vc::oid4vp::int::{AuthorizationRequest, AuthorizationResponse, VerifierMetadata};
use crate::vc::oid4vp::int::verifier_profile::DefaultVerifierProfile;
use crate::vc::oid4vp::VerifierError;
...
mod tests {
    ...
    use crate::vc::oid4vp::int::{AuthorizationUrlType, default_wallet_metadata};
    use crate::vc::oid4vp::int::test_utils::{crate_authorization_response, create_test_presentation_definition, create_test_verifier_metadata};
