...
## Purpose
Contains the complete integration and end-to-end test suite for EQUS Credentials SDK, organized into shared
...
| `e2e/`   | End-to-end tests for all major SDK flows (vc_core, vc_oid4vci, vc_oid4vp, waci_aries, protocol_engine, custom_did_resolvers) — see [e2e/CLAUDE.md](e2e/CLAUDE.md). |
