...
| `metadata.rs` | `MetadataDiscovery` — NAPI class wrapping `EqusSdkMetadataDiscovery`. Exposes `discover_issuer_metadata` and `discover_auth_server_metadata`. |
...
## Dependencies
- Depends on: `equs_sdk::vc::oid4vci`, `crate::vc::core`, `crate::kms::JsKms`, `crate::vault::JsVault`, `crate::http::ReqwestHttpClient`, `crate::nonce::JsNonceHandler`, `crate::did::JsDIDResolver`
