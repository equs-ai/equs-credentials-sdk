...
export class OID4VPVerifier {
   ...
   *    * {string | undefined | null } [audience] - In the case of DC API response mode, audience is the bare Origin of the Verifier (e.g. `https://verifier.example.com`) and while verifying the SDK binds the presentation to `origin:<Origin>`.
