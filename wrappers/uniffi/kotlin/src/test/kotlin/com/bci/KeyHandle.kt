...
import com.bci.asdk.Alg
import com.bci.asdk.KeyHandle as ASDKKeyHandle
import com.bci.asdk.setJniLibPath
import com.bci.asdk.wrapKeyHandleForTests
...
class KeyHandle {
    ...
    private fun mockKeyHandle(): ASDKKeyHandle {
        return wrapKeyHandleForTests(MockKeyHandle())
    }
}

class MockKeyHandle : ASDKKeyHandle {
