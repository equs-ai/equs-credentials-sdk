...
enum CredentialOfferResolverTestConstants {
	...
	static let CredOfferWithPreAuthGrant =
		"{\"credential_issuer\":\"http://localhost:9002\",\"credential_configuration_ids\":[\"IDENTITY_SD_JWT\"],\"grants\":{\"urn:ietf:params:oauth:grant-type:pre-authorized_code\":{\"pre-authorized_code\":\"code\",\"tx_code\":null,\"interval\":null,\"authorization_server\":\"http://localhost:9002/auth\"}}}"
}
