...
final class MockDIDResolver : EqusSdk.DidResolver {
    ...
    func resolveRepresentation(did: String, options: EqusSdk.DidResolutionOptions) async throws -> EqusSdk.DidResolution {
        return EqusSdk.DidResolution(
            document: didResolutionDocument(method: self.methodName()),
            documentMetadata: DidDocMetadata(
                deactivated: nil
            ),
            metadata: EqusSdk.DidMetadata(
