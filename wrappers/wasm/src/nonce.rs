...
use equs_sdk::nonce::{GenerateSnafu, InvalidateSnafu, Nonce, ValidateSnafu};
...
#[async_trait(?Send)]
impl equs_sdk::nonce::NonceHandler for JsNonceHandler {
    ...
    async fn invalidate(&self, nonces: &[Nonce]) -> equs_sdk::nonce::Result<()> {
