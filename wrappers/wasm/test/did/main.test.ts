import {  DIDVerificationMethod, NativeDIDResolver } from "agent-sdk";
...
describe("DID: ", () => {
  ...
  describe("Universal Resolver: ", () => {
    ...
    test("Resolve verification method", async () => {
      const result = await resolver.resolve_verification_method("did:key:zDnaefX6jBNVFnFeUPMRGo6exaVdJ1TRCwuhm296PbB5gPTj6");
